...
class resturrent {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(menuListGetFileData.searchDataINFile("1")));
        System.out.println(Arrays.toString(orderDetailsGetFileData.searchDataINFile("101")));
    }
}
